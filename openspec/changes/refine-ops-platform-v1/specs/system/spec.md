...
### Requirement: Comptes voyageurs multi-user B2C

(Deprecated — hors scope v1 ; éventuelle version lointaine)

### Requirement: Canal push et quiet hours individuelles

(Deprecated — remplacé par Email SMTP + Teams partagés)
